...
export const aiStudyQuizGateOptions: GateOptionsDefinition = {
  cardDescription:
    "Uses the configured AI provider to generate a short study question on a topic you choose.",
  detailsSummary: "Details",
  notes: [
    "Uses the same Chrome local or OpenAI provider settings as AI-reviewed request.",
    "The block page asks for a topic, then asks you to answer the generated question.",
  ],
};
