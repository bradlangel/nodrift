...
- **Temporary Allow (`temporary-allow/`)**: One-click temporary allow grants domain access for the configured duration, with an optional globally counted daily delay after repeated successful allows.
